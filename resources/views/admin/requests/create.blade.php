...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.requests.store']]) !!}
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('no_phonenumber', 1, old('no_phonenumber', false), []) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('no_email', 1, old('no_email', false), []) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('no_form', 1, old('no_form', false), []) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('no_content', 1, old('no_content', false), []) !!}
                    <p class="help-block"></p>
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    ...
                    {!! Form::checkbox('no_faq', 1, old('no_faq', false), []) !!}
                    <p class="help-block"></p>
