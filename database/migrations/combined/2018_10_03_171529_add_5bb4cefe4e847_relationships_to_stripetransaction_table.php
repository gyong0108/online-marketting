...
class Add5bb4cefe4e847RelationshipsToStripeTransactionTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function down()
    {
        Schema::table('stripe_transactions', function(Blueprint $table) {
            if(Schema::hasColumn('stripe_transactions', 'transaction_user_id')) {
                $table->dropForeign('214975_5bb4ca881e1f9');
                $table->dropIndex('214975_5bb4ca881e1f9');
